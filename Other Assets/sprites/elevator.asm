...
SUB_MOVEMENT        JSL $019138
                    
                    LDY #$00
                    LDA SPRITE_STATE,x
                    BEQ SET_SPEED
                    
                    LDA SPR_OBJ_STATUS,x    ;if the elevator is on the ground
                    AND #$04
                    BNE NOT_DOWN
...
NOT_DOWN            LDA $77                 ;if mario is touching the ceiling
                    AND #$08
                    BNE SET_SPEED
