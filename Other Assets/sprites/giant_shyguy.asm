;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; Giant Shy Guy, based on mikeyk's code
;;
;; Description: A Giant Shy Guy with many available configurations.
;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
SPIN_KILL_DISABLED  LDA #$01                ; \ set "on sprite" flag
                    ...
                    STZ $7D                 ; y speed = 0
                    LDA #$D6                ; \
                    LDY $187A               ;  | mario's y position += D6 or C6 depending if on yoshi
                    BEQ NO_YOSHI            ;  |
                    LDA #$C6                ;  |
NO_YOSHI            CLC                     ;  |
                    ADC $D8,x               ;  |
...
HORIZ_DISP          dcb $F8,$08,$F8,$08,$F8,$08,$F8,$08
                    dcb $08,$F8,$08,$F8,$08,$F8,$08,$F8
VERT_DISP           dcb $F0,$F0,$00,$00,$F0,$F0,$00,$00
                    dcb $F0,$F0,$00,$00,$F0,$F0,$00,$00
PROPERTIES          dcb $40,$00             ;xyppccct format

SPRITE_GRAPHICS     JSR GET_DRAW_INFO       ; after: Y = index to sprite tile map ($300)
